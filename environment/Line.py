...
class Line:
    ...
    def get_distance_between_stations(self, station_a, station_b):
        return self.station_distances.get((station_a.get_station_name(), station_b.get_station_name())) \
    or self.station_distances.get((station_b.get_station_name(), station_a.get_station_name()))
