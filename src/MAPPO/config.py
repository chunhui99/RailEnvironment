...
def get_config():
    ...
    parser.add_argument("--algorithm_name", type=str,
                        default='rmappo', choices=["rmappo", "mappo", "happo", "hatrpo", "mat", "mat_dec","ippo"])
    ...
    # env parameters
    parser.add_argument("--env_name", type=str, default='RailScheduleV2', help="specify the name of environment")
    ...
    parser.add_argument("--eval_interval", type=int, default=15, help="time duration between contiunous twice evaluation progress.")
